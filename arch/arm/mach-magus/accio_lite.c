...
static void gpio_setting(void)
{
	...
	*(volatile uint32_t *)(MAGUS_VIO_GPIO | 0x518) = 0x00803004;
	*(volatile uint32_t *)(MAGUS_VIO_GPIO | 0x520) = 0x00803004;
	*(volatile uint32_t *)(MAGUS_VIO_GPIO | 0x53C) = 0x00002004;
}
