/*
 * arch/arm/mach-magus/accio_pf101.c
 */
...
#ifdef CONFIG_ACCIO_PF101_01
#include "lcdm_lq035.h"
#elif defined CONFIG_ACCIO_PF101_02 /* MID WVGA */
#include "lcdm_td043.h"
#endif
...
static void accio_pf101_power_off(void)
{
...
static void accio_pf101_restart(char mode)
{
	...
	*(volatile uint32_t *)(watchdog_vadd | 0x00c) = 0x001;	// reset system after 1second.
	...
	mdelay(2000);
	printk("Reboot failed in accio_pf101_restart().\n");
	while (1);
}
...
#endif
	pm_power_off = accio_pf101_power_off;
	arm_pm_restart = accio_pf101_restart;
}
...
MACHINE_START(MAGUS_ACCIO, "Solomon Magus Accio PF101")
	.phys_io		= MAGUS_IO,
