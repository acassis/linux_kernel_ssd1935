...
static int soc_codec_close(struct snd_pcm_substream *substream)
{
	...
	if ((codec_dai->ops.shutdown) && (codec->restore_flag == 0))
  ...
  if(codec->codec_restore)
    codec->codec_restore(codec, codec->restore_flag);  
...
static int soc_pcm_prepare(struct snd_pcm_substream *substream)
{
  ...
  /* Jianfeng updated on 15 Dec 07 for magus platform */
